...
const Skills = () => {
  return (
    <div className="w-full h-[100vh] mt-[20vh] skill-title">
      ...
      <div className="mt-[10vh] w-[50vw] grid grid-cols-4 gap-[5vh] skill-title">
        <div className="w-fit h-fit flex flex-col gap-[2vh] skill-title">
          <div className="border-2 rounded-3xl px-[6vh] py-[5vh] rounded- gap-[2vh] w-fit h-fit flex flex-col items-center">
